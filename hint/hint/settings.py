"""
Django settings for hint project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            "environment": "hint.jinja2.environment",
        },
    },
]

WSGI_APPLICATION = 'hint.wsgi.application'
...
# STATIC_URL = 'static/'
STATIC_URL = os.environ.get("HINT_STATIC_URL",
                            default='/hint_static/')
